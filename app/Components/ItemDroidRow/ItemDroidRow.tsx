...
import { ItemDroid } from '@/utils/diceroller';
import { MaterialCommunityIcons } from '@expo/vector-icons';
import ItemStatBox from '../ItemStatBox/ItemStatBox';

export interface ItemDroidRowProps {
    itemDroidToShow: ItemDroid;
}

export default function ItemDroidRow({itemDroidToShow} : ItemDroidRowProps): JSX.Element {
        ...
        >
            ...
            >
                ...
                <View style={[styles.leftContainerWrap, { marginLeft: 8 }]}>
                    <MaterialCommunityIcons name="android" size={24} color={colors.itemTypeColor} />
                </View>
            ...
            >
                ...
                <ItemStatBox value={itemDroidToShow.encumbrance} stat='Enc'/>

                <ItemStatBox value={itemDroidToShow.rarity} stat='Rar'/>

            </View>

            {
                itemDroidToShow.description
                ?
            ...
            {
                !isOpen && itemDroidToShow.details
                ?
                <View 
                    style={[
                        styles.rowRounded,
