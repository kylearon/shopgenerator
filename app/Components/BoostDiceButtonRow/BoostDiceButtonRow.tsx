...
export interface BoostDiceButtonRowProps {
    onSelected: (val: number) => void;
    initialValue: number;
}

export default function BoostDiceButtonRow({onSelected, initialValue} : BoostDiceButtonRowProps): JSX.Element {
                ...
                {['0', '1', '2', '3', '4', '5', '6'].map((title) => (
                    <ToggleButton
                        ...
                        style={[styles.buttonStyle, {
                            borderColor: colors.boostDiceColor,
                        }]}
