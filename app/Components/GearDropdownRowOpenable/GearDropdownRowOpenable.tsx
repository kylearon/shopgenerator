...
export default function GearDropdownRowOpenable({title, onPress, style, textStyle= styles.buttonText, disabled = false} : GearDropdownRowOpenableProps): JSX.Element {
